...
Procedure TRegistro.Calcula_PWRD;
Var
  I,X,Cont:Integer;
  Esta:Boolean;
  Diferencia:Real;
...
// UtilizaciÛn de Senos para generaciÛn de Claves
  VRPWRD:='';
  For Cont:=1 to Length(Tempo2) do
    Begin
      If Tempo2[Cont] = '-' Then
          ...
          try
           with registro do
            begin
              ...
              Principal.Timer1.Enabled:=False;
              Principal.RegistrarProducto1.Visible:=False;
              Principal.N2.Visible:=False;
              Messagedlg('Felicidades !, Ha completado con Èxito el registro del '
